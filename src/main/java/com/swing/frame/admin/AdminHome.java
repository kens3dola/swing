...
//	}
	...
	public AdminHome(int id) {
		...
		tabbedPane_1.setBackground(SystemColor.text);
		tabbedPane_1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				int i = tabbedPane_1.getSelectedIndex();
				switch (i) {
				case 0:
		...
		tabbedPane_1.setBounds(0, 0, 746, 520);
		contentPane.add(tabbedPane_1);

		// Show tab
		showTabInit(tabbedPane_1);

		// movie tab
		movieTabInit(tabbedPane_1);

		// user tab
		userTabInit(tabbedPane_1);
	}

	private void showTabInit(JTabbedPane tabbedPane) {
		JDateChooser date = new JDateChooser();
		date.getCalendarButton().setName("dateBtn");
		...
		movieList2.setName("scheduleList");
		...
		tabbedPane.addTab("Manage shows", new ImageIcon(AdminHome.class.getResource("/design/icons8_tv_22px.png")), panel1, null);
		tabbedPane_1.setForegroundAt(0, new Color(0, 51, 255));
		...
		show_table.setName("showtimeTable");
		...
		scroll1.setBounds(326, 34, 405, 450);
		panel1.add(scroll1);
		...
		showNew.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (m != null && s != null && d != null && r != null) {
					...
					JOptionPane.showMessageDialog(null, "Please choose one movie, one schedule and a date");
				}
			}
		});
		showNew.setBounds(95, 443, 100, 30);
		panel1.add(showNew);
		...
		btnNewButton_4.setBounds(645, 0, 85, 30);
		...
		lblNewLabel_11.setBounds(10, 34, 306, 80);
	...
	private void movieTabInit(JTabbedPane tabbedPane) {
		...
		tabbedPane.addTab("Manage movies", new ImageIcon(AdminHome.class.getResource("/design/icons8_movie_22px_2.png")), panel1, null);
		tabbedPane_1.setForegroundAt(1, new Color(0, 51, 255));
		tabbedPane_1.setBackgroundAt(1, Color.WHITE);
		movie_table.setName("movieTable");
		...
		addMovie.setBounds(114, 443, 100, 30);
		panel1.add(addMovie);
		...
		btnNewButton_1.setName("movieUpdate");
		btnNewButton_1.setBounds(550, 0, 85, 30);
		...
		btnNewButton_4.setName("movieDelete");
		btnNewButton_4.setBounds(645, 0, 85, 30);
		panel1.add(btnNewButton_4);
		...
		lblNewLabel_10.setBounds(10, 34, 306, 80);
	...
	private void userTabInit(JTabbedPane tabbedPane) {
		...
		tabbedPane.addTab("Manage users", new ImageIcon(AdminHome.class.getResource("/design/icons8_user_22px.png")), panel1, null);
		tabbedPane_1.setForegroundAt(2, new Color(0, 51, 255));
		tabbedPane_1.setBackgroundAt(2, Color.WHITE);
		user_table.setName("accountTable");
		...
		scroll1.setBounds(326, 34, 406, 450);
		panel1.add(scroll1);
		...
		showNew.setBounds(91, 443, 100, 30);
		panel1.add(showNew);
		...
		btnNewButton_1.setName("accountUpdate");
		btnNewButton_1.setBounds(550, 0, 85, 30);
		panel1.add(btnNewButton_1);
		...
		btnNewButton_4.setName("accountDelete");
		btnNewButton_4.setBounds(645, 0, 85, 30);
		panel1.add(btnNewButton_4);
		...
		lblNewLabel_12.setBounds(10, 34, 306, 80);
